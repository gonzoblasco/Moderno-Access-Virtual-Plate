...
function loadcalendar() {
    ...
    s += '<tr align="center" id="calendar_week"><td><a href="###" onclick="refreshcalendar(yy, mm-1)" title="back"><<</a></td><td colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');doane(event)" class="dropmenu" title="click choose year" id="year"></a>&nbsp; - &nbsp;<a id="month" class="dropmenu" title="click choose month" href="###" onclick="showdiv(\'month\');doane(event)"></a></td><td><A href="###" onclick="refreshcalendar(yy, mm+1)" title="next">>></A></td></tr>';
    ...
    s += '<tr id="hourminute"><td colspan="7" align="center"><input type="text" size="2" value="" id="hour" onKeyUp=\'this.value=this.value > 23 ? 23 : zerofill(this.value);controlid.value=controlid.value.replace(/\\d+(\:\\d+)/ig, this.value+"$1")\'>H<input type="text" size="2" value="" id="minute" onKeyUp=\'this.value=this.value > 59 ? 59 : zerofill(this.value);controlid.value=controlid.value.replace(/(\\d+\:)\\d+/ig, "$1"+this.value)\'>Min</td></tr>';
    s += '</table></div></div>';
    s += '<div id="calendar_year" onclick="doane(event)" style="display: none"><div class="col">';
//    for(var k = 1930; k <= 2019; k++) {
    for(var k = minYear; k <= maxYear; k++) {
//        s += k != 1930 && k % 10 == 0 ? '</div><div class="col">' : '';
        s += k != minYear && k % 10 == 0 ? '</div><div class="col">' : '';
    ...
    parentdiv.setAttribute('id','append_parent');
